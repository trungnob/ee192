...
//	char buf[128];
   ...
   IRQ = My_IRQ_Function;
	...
	GP3CON &= 0xFCFFFFFF; //configure 3.6 to be GPIO  ...  Hall 3 
...
Test1=IRQSIG;
 ...
 Test2=IRQSTA ;
	...
	//	T1LD = 0x1;
		...
		/*if (INT_period >= INT_PERIOD_TOP) {
			INT_period = 0;
			GP4DAT = 0x04040000;						// Complement P4.2
		} else if (INT_period >= (INT_PERIOD_TOP * INT_degree/100)) {
			GP4DAT = 0x04000000;
		}
	} 
...
void ADCinit(void) {
	...
	//T0LD = 0x5000;					// 5*4096/40.96MHz = 100us
